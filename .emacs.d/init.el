...
(custom-set-faces
 ...
 '(cursor ((t (:background "firebrick" :foreground "#fdf6e3" :inverse-video t)))))
(package-initialize)
;; THEME LOAD
...
(eval-after-load 'jdee
  '(local-set-key (kbd "C-c C-v C-i") 'jdee-import-all))
;; JAVA INDENT
